...
public class CreateAccountAdapter extends BaseAdapter {
	...
	private void populateFirstForm(LinearLayout formLayout) {
		...
		EditText nameEditText = createEditText(mContext.getString(R.string.account_create_full_name_hint),InputType.TYPE_CLASS_TEXT, EditorInfo.IME_ACTION_NEXT, false,FULL_NAME_KEY);
		...
		EditText emailEditText = createEditText(mContext.getString(R.string.account_create_email_hint),InputType.TYPE_CLASS_TEXT, EditorInfo.IME_ACTION_NEXT, true,EMAIL_KEY);
	...
	private void populateSecondForm(LinearLayout formLayout) {
		...
		EditText passwordEditText = createEditText(mContext.getString(R.string.account_create_password_hint),InputType.TYPE_CLASS_TEXT, EditorInfo.IME_ACTION_DONE, false,PASSWORD_KEY);
		...
		final ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(mContext, R.array.sexes_array,android.R.layout.simple_spinner_item);
	...
	private void populateThirdForm(LinearLayout formLayout) {
		...
		EditText cityEditText = createEditText(mContext.getString(R.string.account_create_city_hint),InputType.TYPE_CLASS_TEXT, EditorInfo.IME_ACTION_DONE, false,CITY_KEY);
		...
		final ArrayAdapter<String> adapter = new ArrayAdapter<String>(mContext,android.R.layout.simple_spinner_item, Countries.COUNTRIES);
		spinner.setAdapter(adapter);
	...
	private void populateFourthForm(LinearLayout formLayout) {
		formLayout.addView(createTitle(mContext.getString(R.string.account_create_zip_title)));
		EditText zipEditText = createEditText(mContext.getString(R.string.account_create_zip_hint),InputType.TYPE_CLASS_TEXT, EditorInfo.IME_ACTION_GO, true,ZIP_KEY);
	...
	private EditText createEditText(String hint, int inputType, int imeOption,boolean shouldMoveToNext, final String key) {
